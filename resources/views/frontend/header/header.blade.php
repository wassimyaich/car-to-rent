  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar"
      ...
      <div class="container">
          ...
          @auth
              <div class="dropdown">
                  <button class="btn btn-outline-primary nav-button mx-3 dropdown-toggle" type="button" id="navbarDropdown"
                                      ...
                                      <div class="tabs-listing">
                                          ...
                                          <div class="tab-content" id="nav-tabContent">
                                              <div class="tab-pane fade active show" id="nav-sign-in" role="tabpanel"
                                                  ...
                                                  <form id="form1"
                                                      class="form-group flex-wrap p-3 "action="{{ route('postlogin') }}"
                                                      method="POST">
                                                      @csrf
                                              ...
                                              <div class="tab-pane fade" id="nav-register" role="tabpanel"
                                                  ...
                                                  <form id="form2"
                                                      class="form-group flex-wrap p-3 "action="{{ route('postregister') }}"
                                                      method="POST">
                                                      @csrf
                                                      <div class="form-input col-lg-12 my-4">
                                                          <label for="name"
                      ...
                      <div class="modal-dialog">
                          <div class="modal-content">
                              ...
                              <div class="modal-body">
                                  <div class="tabs-listing">
                                      <nav>
                                          <div class="nav nav-tabs d-flex justify-content-center border-0" id="nav-tab2"
                                              role="tablist">
