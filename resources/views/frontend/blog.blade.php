...
<html lang="en">
  ...
  <body>
    ...
    <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('{{ asset('/storage/frontend/pages/' . \App\Models\Setting::first()->blog_image) }}');" data-stellar-background-ratio="0.5">
